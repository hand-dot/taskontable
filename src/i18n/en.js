...
Feel free to feedback! We are always waiting for your feedback !`,
  ...
  worksheet: {
    ...
    dashBoad: 'DashBoad',
    members: 'Members',
    disclosureRange: 'Disclosure Range',
    plugIns: 'PlugIns',
    activity: 'Activity',
    ...
    setDisclosureRangeTo_target: 'Set Disclosure Range to %{target}.',
    ...
    locked: 'It is locked because it is being edited. Input content may be overwritten... You can also take lock by pressing [X] at the top of the screen😎',
    tookLock_target: 'Oops. %{target} took lock!',
    pleaseSaveAndUnlock: 'Please save after editing and unlock it.',
    isEditing_target: '%{target} is editing it is locked.',
    takeLock_target: 'Do you take lock of %{target}?\nIf there is a change to %{target}\'s is not saved, %{target} may feel sad ...',
    tookLock: 'Took lock of %{target}!',
  },
  dashBoad: {
    summary: 'Summary',
    clock: 'Clock',
  ...
  disclosureRange: {
    areYouSureSetDisclosureRangeTo_target: 'Are you sure set disclosure range to %{target}?',
    changeDisclosureRange: 'Change Disclosure Range',
    copied: 'Copied',
