...
function SnsShare(props) {
  ...
  return (
    <div>
      ...
      <div style={style}>
        <GooglePlusShareButton url={shareUrl}><GooglePlusIcon size={32} round /></GooglePlusShareButton>
      </div>
      <div style={style}>
        <LinkedinShareButton url={shareUrl} title={title} windowWidth={750} windowHeight={600}><LinkedinIcon size={32} round /></LinkedinShareButton>
      </div>
      <div style={style}>
        <RedditShareButton url={shareUrl} title={title} windowWidth={660} windowHeight={460}><RedditIcon size={32} round /></RedditShareButton>
      </div>
      <div style={style}>
        <TumblrShareButton url={shareUrl} title={title} windowWidth={660} windowHeight={460}><TumblrIcon size={32} round /></TumblrShareButton>
      </div>
      <div style={style}>
      ...
      <div style={style}>
        <EmailShareButton url={shareUrl} subject={title} body={shareUrl}><EmailIcon size={32} round /></EmailShareButton>
      </div>
      <div style={style}>
        <ViberShareButton url={shareUrl} title={title} body={shareUrl}><ViberIcon size={32} round /></ViberShareButton>
      </div>
    </div>
  );
}
