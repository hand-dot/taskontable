...
export default {
  ...
  getEstimateTimelineChartTasks(tasks) {
    ...
    const getTimelineChartTask = t => ({
      start: moment(t.startTime, constants.TIMEFMT).toDate(), end: moment(t.startTime, constants.TIMEFMT).add(t.estimate || 0, 'minutes').toDate(), title: t.title || i18n.t('common.anonymousTask'),
    });
  ...
  getActuallyTimelineChartTasks(tasks) {
    const getTimelineChartTask = t => ({
      start: moment(t.startTime, constants.TIMEFMT).toDate(), end: moment(t.endTime, constants.TIMEFMT).toDate(), title: t.title || i18n.t('common.anonymousTask'),
    });
